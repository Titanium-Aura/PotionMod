...
public class DescentEffect extends InstantenousMobEffect {
    public DescentEffect(MobEffectCategory category, int color) {
    ...
    private void teleportToValidPosition(LivingEntity livingEntity, int amplifier) {
        ...
        livingEntity.teleportTo(pos.x + 0.5, pos.y, pos.z + 0.5);
    }
